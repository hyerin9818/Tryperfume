...
<body>
	...
	<div class="page">
            ...
            <hr>
            <div class="page4">
                <a href="<c:url value="/faq"/>">목록</a>
                <c:if test="${memId eq 'admin'}">
        
                <a href="<c:url value="./updatefaq?anum=${faq.anum }"/>">게시물 수정</a>
                <a href="<c:url value="./delect?anum=${faq.anum }"/>">게시물 삭제</a>
            	</c:if>
            </div>
