...
<body>
	<%@ include file = "nav.jsp" %>
	 <div class="writemain">
            <form name="faq" action="./add" method="post">
                <p class="writetitle">FAQ 작성</p>
                <div class="writeboardmain">
                    
                    <div>
                        <p class="wr2">
                            제목 <input type="text" name="atname" required>
                        </p>
                    </div>
                    <div>
                        <p class="wr2">
                    ...
                    <div>
                        <p class="wr3">내용</p>
                        <textarea name="atmain" id="atmain" cols="80" rows="30"></textarea>
                    </div>
                </div>
                <div>
                    <div>
