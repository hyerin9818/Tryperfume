...
<body>
	<%@ include file = "nav.jsp" %>
	 <div class="writemain">
            <form name="notice" action="./updatenotice" method="post">
                <p class="writetitle">공지사항 수정</p>
                <div class="writeboardmain">
                    
                    <div>
                        <p class="wr2">
                            제목 <input type="text" name="wtname" value="${notice.wtname}" required>
                        </p>
                    </div>
                    <div>
                        <p class="wr2">
                    ...
                    <div>
                        <p class="wr3">내용</p>
                        <textarea name="wtmain" id="wtmain" cols="80" rows="30" value="${notice.wtmain}"></textarea>
                    </div>
                </div>
                <div>
                    <div>
