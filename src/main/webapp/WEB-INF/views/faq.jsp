...
<body>
	...
	<div class="freeboardmain">
            ...
            <table>
                ...
                <tbody>
                 <c:forEach items="${faq}" var="faq">
                    <tr>
                        <td><a href="<c:url value="/faq/faqpage?anum=${faq.anum}"/>"><p>${faq.atname}</p></a></td>
                        <td>${faq.adate}</td>
                        <td>관리자</td>
                        <td>${faq.aviews}</td>
                    </tr>
        ...
        <div class="fr3">
            <div class="fr3">
                <a href="<c:url value="faq/writelist"/>"><p class="frlist1">내 글 목록</p></a>
                <a href="<c:url value="faq/faqwrite"/>"><p class="frlist2">게시물 작성</p></a>
            </div>
