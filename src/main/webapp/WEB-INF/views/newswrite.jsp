...
<body>
	<%@ include file = "nav.jsp" %>
	 <div class="writemain">
            <form name="news" action="./add" method="post">
                <p class="writetitle">NEWS 작성</p>
                <div class="writeboardmain">
                    
                    <div>
                        <p class="wr2">
                            제목 <input type="text" name="stname" required>
                        </p>
                    </div>
                    <div>
                        <p class="wr2">
                    ...
                    <div>
                        <p class="wr3">내용</p>
                        <textarea name="stmain" id="stmain" cols="80" rows="30"></textarea>
                    </div>
                </div>
                <div>
                    <div>
